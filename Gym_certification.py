...
class king_fitness:
    ...
    def create_mem(self):
        ...
        self.dict_super_mb[phone] = dict_store         
    ...
    def update_mem(self):
        ...
        if self.extd==1:
            ...
            self.dict_super_mb[self.mobi]["Membership Duration(months)"]=self.mem_extnd           
            self.all_member_info[self.mem_id]["Membership Duration(months)"]=self.mem_extnd          
